...
var Neptuo$ObjectBuilder$DependencyContainer = {
    ...
    ctors: [{
        ...
        name: "ctor$$DependencyRegistry$$LifetimeMapping",
        parameters: ["Neptuo.ObjectBuilder.DependencyRegistry", "Neptuo.Lifetimes.Mapping.LifetimeMapping"]
    }
    ],
    IsAbstract: false
};
...
var Neptuo$ObjectBuilder$IDependencyLifetime = {
    fullname: "Neptuo.ObjectBuilder.IDependencyLifetime",
    baseTypeName: "System.Object",
    assemblyName: "Neptuo.ObjectBuilder.Client",
    Kind: "Interface",
    ctors: [],
