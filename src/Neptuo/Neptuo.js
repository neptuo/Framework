...
var Neptuo$ComponentModel$Behaviors$BehaviorCollectionBase = {
    fullname: "Neptuo.ComponentModel.Behaviors.BehaviorCollectionBase",
    baseTypeName: "System.Object",
    assemblyName: "Neptuo",
    ...
    definition: {
        ...
        GetBehaviors: function (handlerType){
            ...
            var $it8 = this.providers.GetEnumerator();
            while ($it8.MoveNext()){
                var provider = $it8.get_Current();
...
var Neptuo$ComponentModel$Behaviors$Processing$Compilation$FuncList$2 = {
    fullname: "Neptuo.ComponentModel.Behaviors.Processing.Compilation.FuncList$2",
    baseTypeName: "System.Object",
    assemblyName: "Neptuo",
    Kind: "Class",
    definition: {
        ctor: function (TInput, TOutput, handlers){
            ...
            System.Object.ctor.call(this);
            var $it9 = handlers.GetEnumerator();
            while ($it9.MoveNext()){
        ...
        Execute: function (input){
            var output;
            var $it10 = this.delegates.GetEnumerator();
            while ($it10.MoveNext()){
                var handler = $it10.get_Current();
...
JsTypes.push(Neptuo$ComponentModel$Behaviors$Processing$Compilation$FuncList$2);
...
var Neptuo$ComponentModel$Behaviors$Processing$Compilation$CodeDomBehaviorInstanceRegistry = {
    ...
    definition: {
        ctor: function (){
            ...
            this.onSearchBuilder = new Neptuo.ComponentModel.Behaviors.Processing.Compilation.FuncList$2.ctor(System.Type.ctor, Neptuo.ComponentModel.Behaviors.Processing.Compilation.ICodeDomBehaviorInstanceGenerator.ctor, $CreateAnonymousDelegate(this, function (o){
...
var Neptuo$ComponentModel$Behaviors$Processing$_EnvironmentExtensions = {
    ...
    staticDefinition: {
        ...
        UseBehaviors$$EngineEnvironment$$IBehaviorProvider$Array: function (environment, providers){
            ...
            var $it11 = providers.GetEnumerator();
            while ($it11.MoveNext()){
...
var Neptuo$ComponentModel$Behaviors$Processing$Compilation$CodeDomPipelineConfiguration = {
    ...
    definition: {
        ...
        ctor$$Type$$String$$String$Array: function (baseType, tempDirectory, binDirectories){
            ...
            var $it12 = binDirectories.GetEnumerator();
            while ($it12.MoveNext()){
                var binDirectory = $it12.get_Current();
...
var Neptuo$ComponentModel$Behaviors$Processing$Compilation$CodeDomPipelineGenerator = {
    ...
    definition: {
        ...
        GenerateBehaviorMethodBody: function (method){
            ...
            var $it13 = behaviorTypes.GetEnumerator();
            while ($it13.MoveNext()){
                var behaviorType = $it13.get_Current();
...
var Neptuo$ComponentModel$Behaviors$Processing$DefaultPipeline$1 = {
    ...
    definition: {
        ...
        GetBehaviors: function (){
            ...
            var $it14 = behaviorTypes.GetEnumerator();
            while ($it14.MoveNext()){
                var behaviorType = $it14.get_Current();
    ...
    ctors: [{
        name: "ctor",
        parameters: ["Neptuo.ComponentModel.Behaviors.IBehaviorCollection"]
    }
    ],
    IsAbstract: false
};
...
var Neptuo$ComponentModel$Behaviors$Providers$InterfaceBehaviorProvider = {
    ...
    definition: {
        ...
        GetBehaviorInternal: function (handlerType, storage){
            ...
            var $it15 = handlerType.GetInterfaces().GetEnumerator();
            while ($it15.MoveNext()){
                var interfaceType = $it15.get_Current();
                if ((function (){
                    var $1 = {
...
var Neptuo$ComponentModel$Converters$CollectionConverter$1 = {
    ...
    definition: {
        ...
        TryConvertList: function (sourceValue, targetValue){
            ...
            var $it16 = sourceValues.GetEnumerator();
            while ($it16.MoveNext()){
                var itemValue = $it16.get_Current();
                var item;
                if ((function (){
                    var $1 = {
                        Value: item
...
var Neptuo$Pipelines$Commands$Interception$AttributeInterceptorProvider = {
    ...
    definition: {
        ...
        AppendInterceptors: function (source, result){
            var $it17 = source.GetCustomAttributes$$Boolean(true).GetEnumerator();
            while ($it17.MoveNext()){
...
var Neptuo$Pipelines$Commands$Interception$ManualInterceptorProvider = {
    ...
    definition: {
        ...
        GetInterceptors: function (commandHandler, command, commandHandlerMethod){
            ...
            var result = new System.Collections.Generic.List$1.ctor(Neptuo.Pipelines.Commands.Interception.IDecoratedInvoke.ctor);
            var $it18 = interceptorFactories.GetEnumerator();
            while ($it18.MoveNext()){
                var interceptorFactory = $it18.get_Current();
...
var Neptuo$Globalization$CultureInfoExtensions = {
    ...
    staticDefinition: {
        TryParse: function (value, cultureInfo){
            ...
            var $it19 = System.Globalization.CultureInfo.GetCultures(7).GetEnumerator();
            while ($it19.MoveNext()){
...
var Neptuo$VersionInfo = {
    ...
    staticDefinition: {
        cctor: function (){
            Neptuo.VersionInfo.Version = "3.9.0";
        },
        GetVersion: function (){
            return new System.Version.ctor$$String("3.9.0");
        }
    },
    assemblyName: "Neptuo",
    Kind: "Class",
...
var Neptuo$Reflection$DefaultReflectionService = {
    ...
    definition: {
        ...
        LoadType: function (typeAssemblyName){
            ...
            var $it20 = searchIn.GetEnumerator();
            while ($it20.MoveNext()){
                var assembly = $it20.get_Current();
