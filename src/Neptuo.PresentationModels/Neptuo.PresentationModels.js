...
var Neptuo$PresentationModels$MetadataCollection = {
    ...
    definition: {
        ...
        Add: function (identifier, value){
            Neptuo.Collections.Specialized.KeyValueCollection.commonPrototype.Add.call(this, identifier, value);
            return this;
        }
    },
    ctors: [{
...
var Neptuo$PresentationModels$ModelDefinitionCollection = {
    ...
    definition: {
        ctor: function (){
            ...
            this.builders = new System.Collections.Generic.Dictionary$2.ctor(System.String.ctor, Neptuo.Activators.IFactory$1.ctor);
            this.onSearchDefinition = new Neptuo.OutFuncCollection$3.ctor(System.String.ctor, Neptuo.PresentationModels.IModelDefinition.ctor, System.Boolean.ctor);
            System.Object.ctor.call(this);
        },
        ...
        Add$$String$$IFactory$1$IModelDefinition: function (modelIdentifier, modelDefinitionBuilder){
        ...
        TryGet: function (modelIdentifier, modelDefinition){
            ...
            if (Neptuo._OutFuncCollectionExtensions.TryExecute$2(System.String.ctor, Neptuo.PresentationModels.IModelDefinition.ctor, this.onSearchDefinition, modelIdentifier, modelDefinition)){
...
var Neptuo$PresentationModels$TypeModels$Expressions$ExpressionModelValueProvider$1 = {
    ...
    definition: {
        ...
        ValueProviders$$: "Neptuo.PresentationModels.TypeModels.Expressions.IFieldValueProviderProvider`1[[`0]]",
    ...
    ctors: [{
        name: "ctor",
        parameters: ["TModel", "Neptuo.PresentationModels.TypeModels.Expressions.IFieldValueProviderProvider"]
    }
    ],
    IsAbstract: false
};
...
var Neptuo$PresentationModels$TypeModels$Expressions$FieldValueProviderCollection$1 = {
    ...
    baseTypeName: "System.Object",
    assemblyName: "Neptuo.PresentationModels",
    interfaceNames: ["Neptuo.PresentationModels.TypeModels.Expressions.IFieldValueProviderProvider$1"],
    Kind: "Class",
    definition: {
...
var Neptuo$PresentationModels$TypeModels$Expressions$IFieldValueProviderProvider$1 = {
    fullname: "Neptuo.PresentationModels.TypeModels.Expressions.IFieldValueProviderProvider$1",
    baseTypeName: "System.Object",
    assemblyName: "Neptuo.PresentationModels",
    Kind: "Interface",
    ctors: [],
...
JsTypes.push(Neptuo$PresentationModels$TypeModels$Expressions$IFieldValueProviderProvider$1);
...
var Neptuo$PresentationModels$TypeModels$ValueUpdates$IReflectionValueUpdater = {
    fullname: "Neptuo.PresentationModels.TypeModels.ValueUpdates.IReflectionValueUpdater",
    baseTypeName: "System.Object",
    assemblyName: "Neptuo.PresentationModels",
    Kind: "Interface",
    ctors: [],
...
JsTypes.push(Neptuo$PresentationModels$TypeModels$ValueUpdates$IReflectionValueUpdater);
...
var Neptuo$PresentationModels$TypeModels$TypeModelDefinitionCollection = {
    ...
    definition: {
        ctor: function (){
            ...
            this.onSearchDefinition = new Neptuo.OutFuncCollection$3.ctor(System.Type.ctor, Neptuo.PresentationModels.IModelDefinition.ctor, System.Boolean.ctor);
            System.Object.ctor.call(this);
        },
        ...
        TryGet: function (modelType, modelDefinition){
            ...
            if (this.singletons.TryGetValue(modelType, modelDefinition))
                return true;
            if (Neptuo._OutFuncCollectionExtensions.TryExecute$2(System.Type.ctor, Neptuo.PresentationModels.IModelDefinition.ctor, this.onSearchDefinition, modelType, modelDefinition)){
...
var Neptuo$PresentationModels$TypeModels$ReflectionModelValueProvider$1 = {
    ...
    Kind: "Class",
    definition: {
        ctor$$TModel: function (TModel, model){
            this.TModel = TModel;
        ...
        get_ValueUpdater: function (){
            return this._ValueUpdater;
        },
        set_ValueUpdater: function (value){
        ...
        ctor$$TModel$$IReflectionValueUpdater: function (TModel, model, valueUpdater){
            this.TModel = TModel;
            this.properties = new System.Collections.Generic.Dictionary$2.ctor(System.String.ctor, System.Reflection.PropertyInfo.ctor);
            this._ValueUpdater = null;
            this._ModelType = null;
            ...
            this.set_ValueUpdater(valueUpdater);
        },
        TryGetValue: function (identifier, value){
        ...
        TrySetValue: function (identifier, value){
            ...
            if ((function (){
                ...
                return this.TrySetValueOnReadOnlyProperty(identifier, propertyInfo, value);
            }
            return false;
        },
        TrySetValueOnReadOnlyProperty: function (identifier, propertyInfo, value){
            return this.get_ValueUpdater().TryUpdate(this.get_Model(), propertyInfo, value);
        },
    ...
    ctors: [{
        ...
        name: "ctor$$TModel$$IReflectionValueUpdater",
        parameters: ["TModel", "Neptuo.PresentationModels.TypeModels.ValueUpdates.IReflectionValueUpdater"]
    }
    ],
    IsAbstract: false
};
...
var Neptuo$PresentationModels$TypeModels$ReflectionModelValueProvider = {
    ...
    Kind: "Class",
    definition: {
        ctor$$Object: function (model){
            Neptuo.PresentationModels.TypeModels.ReflectionModelValueProvider$1.ctor$$TModel.call(this, System.Object.ctor, model);
        },
        ctor$$Object$$IReflectionValueUpdater: function (model, valueUpdater){
            Neptuo.PresentationModels.TypeModels.ReflectionModelValueProvider$1.ctor$$TModel$$IReflectionValueUpdater.call(this, System.Object.ctor, model, valueUpdater);
        }
    },
    ctors: [{
        name: "ctor$$Object",
        ...
        name: "ctor$$Object$$IReflectionValueUpdater",
        parameters: ["System.Object", "Neptuo.PresentationModels.TypeModels.ValueUpdates.IReflectionValueUpdater"]
    }
    ],
    IsAbstract: false
};
...
var Neptuo$PresentationModels$TypeModels$ValueUpdates$CollectionItemReflectionValueUpdater$1 = {
    ...
    definition: {
        ...
        TryUpdate: function (instance, propertyInfo, newValue){
            var collection = As(propertyInfo.GetValue$$Object(instance), System.Collections.Generic.ICollection$1.ctor);
            if (collection == null)
                return false;
            if (newValue == null){
                collection.Clear();
            ...
            var newValues = As(newValue, System.Collections.Generic.IEnumerable$1.ctor);
            if (newValues == null)
                return false;
            collection.Clear();
            var $it5 = newValues.GetEnumerator();
            while ($it5.MoveNext()){
...
var Neptuo$PresentationModels$TypeModels$ValueUpdates$ReflectionValueUpdaterCollection = {
    ...
    definition: {
        ctor: function (){
            this.storage = new System.Collections.Generic.Dictionary$2.ctor(System.Type.ctor, Neptuo.PresentationModels.TypeModels.ValueUpdates.IReflectionValueUpdater.ctor);
            System.Object.ctor.call(this);
        },
        Add: function (propertType, updater){
            Neptuo.Ensure.NotNull$$Object$$String(propertType, "propertType");
            Neptuo.Ensure.NotNull$$Object$$String(updater, "updater");
            this.storage.set_Item$$TKey(propertType, updater);
            return this;
        },
        TryUpdate: function (instance, propertyInfo, newValue){
            ...
            if ((function (){
                ...
                var $res = this.storage.TryGetValue(propertyType, $1);
                updater = $1.Value;
                return $res;
            }).call(this))
...
JsTypes.push(Neptuo$PresentationModels$TypeModels$ValueUpdates$ReflectionValueUpdaterCollection);
var Neptuo$PresentationModels$TypeModels$ValueUpdates$_ReflectionValueUpdaterCollectionExtensions = {
    fullname: "Neptuo.PresentationModels.TypeModels.ValueUpdates._ReflectionValueUpdaterCollectionExtensions",
    baseTypeName: "System.Object",
    staticDefinition: {
        Add$1: function (T, collection, updater){
...
JsTypes.push(Neptuo$PresentationModels$TypeModels$ValueUpdates$_ReflectionValueUpdaterCollectionExtensions);
...
var Neptuo$PresentationModels$Validators$MetadataFieldValidator = {
    ...
    definition: {
        ...
        Validators$$: "Neptuo.PresentationModels.Validators.IFieldMetadataValidatorProvider",
    ...
    ctors: [{
        name: "ctor",
        parameters: ["Neptuo.PresentationModels.Validators.IFieldMetadataValidatorProvider"]
    }
    ],
    IsAbstract: false
};
...
var Neptuo$PresentationModels$Validators$IFieldMetadataValidatorProvider = {
    fullname: "Neptuo.PresentationModels.Validators.IFieldMetadataValidatorProvider",
    baseTypeName: "System.Object",
    assemblyName: "Neptuo.PresentationModels",
    Kind: "Interface",
    ctors: [],
...
JsTypes.push(Neptuo$PresentationModels$Validators$IFieldMetadataValidatorProvider);
...
var Neptuo$PresentationModels$Validators$FieldMetadataValidatorCollection = {
    ...
    baseTypeName: "System.Object",
    assemblyName: "Neptuo.PresentationModels",
    interfaceNames: ["Neptuo.PresentationModels.Validators.IFieldMetadataValidatorProvider"],
    Kind: "Class",
    definition: {
        ctor: function (){
            ...
            this.builders = new System.Collections.Generic.Dictionary$2.ctor(Neptuo.PresentationModels.Validators.FieldMetadataValidatorKey.ctor, Neptuo.Activators.IFactory$1.ctor);
            this.onSearchValidator = new Neptuo.OutFuncCollection$3.ctor(Neptuo.PresentationModels.Validators.FieldMetadataValidatorKey.ctor, Neptuo.PresentationModels.Validators.IFieldMetadataValidator.ctor, System.Boolean.ctor);
            System.Object.ctor.call(this);
        },
        ...
        Add$$String$$String$$String$$IFactory$1$IFieldMetadataValidator: function (modelIdentifier, fieldIdentifier, metadataKey, validator){
        ...
        TryGet: function (modelIdentifier, fieldIdentifier, metadataKey, validator){
            var $it7 = this.LazyEnumerateKeys(modelIdentifier, fieldIdentifier, metadataKey).GetEnumerator();
            while ($it7.MoveNext()){
                ...
                if (Neptuo._OutFuncCollectionExtensions.TryExecute$2(Neptuo.PresentationModels.Validators.FieldMetadataValidatorKey.ctor, Neptuo.PresentationModels.Validators.IFieldMetadataValidator.ctor, this.onSearchValidator, key, validator))
                    return true;
            }
...
var Neptuo$PresentationModels$_ModelDefinitionExtensions = {
    ...
    staticDefinition: {
        FieldsByIdentifier: function (modelDefinition){
            ...
            var $it9 = modelDefinition.get_Fields().GetEnumerator();
            while ($it9.MoveNext()){
                var fieldDefinition = $it9.get_Current();
