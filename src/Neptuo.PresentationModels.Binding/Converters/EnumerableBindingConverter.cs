...
{
    public class EnumerableBindingConverter<T> : BindingConverterBase<IEnumerable<T>>
    {
        protected string Separator { get; private set; }
        protected BindingConverterBase<T> Converter { get; private set; }

        public EnumerableBindingConverter(string separator, BindingConverterBase<T> converter)
        {
