...
{
    /// <summary>
    /// The extensions used in the <see cref="contextFormatter"/> for the <see cref="ISerializerContext"/> and <see cref="IDeserializerContext"/>.
    /// </summary>
    public static class _FormatterContextExtensions
    {
        ...
        public static bool TryGetEnvelopeMetadata(this IDeserializerContext context, out IReadOnlyKeyValueCollection value)
        {
            Ensure.NotNull(context, "context");
        ...
        public static IReadOnlyKeyValueCollection GetEnvelopeMetadata(this IDeserializerContext context)
        {
            Ensure.NotNull(context, "context");
