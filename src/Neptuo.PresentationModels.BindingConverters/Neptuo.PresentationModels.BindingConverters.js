...
var Neptuo$PresentationModels$BindingConverters$BindingConverterCollectionExtensions = {
    ...
    staticDefinition: {
        AddStandart: function (bindingConverters){
            return bindingConverters.Add(new Neptuo.PresentationModels.FieldType.ctor(Typeof(System.Boolean.ctor)), new Neptuo.PresentationModels.BindingConverters.BoolBindingConverter.ctor()).Add(new Neptuo.PresentationModels.FieldType.ctor(Typeof(System.Int32.ctor)), new Neptuo.PresentationModels.BindingConverters.IntBindingConverter.ctor()).Add(new Neptuo.PresentationModels.FieldType.ctor(Typeof(System.Double.ctor)), new Neptuo.PresentationModels.BindingConverters.DoubleBindingConverter.ctor()).Add(new Neptuo.PresentationModels.FieldType.ctor(Typeof(System.String.ctor)), new Neptuo.PresentationModels.BindingConverters.StringBindingConverter.ctor(false, true, true)).Add(new Neptuo.PresentationModels.FieldType.ctor(Typeof(System.Nullable$1.ctor)), new Neptuo.PresentationModels.BindingConverters.NullBindingConverter$1.ctor(System.Boolean.ctor, new Neptuo.PresentationModels.BindingConverters.BoolBindingConverter.ctor())).Add(new Neptuo.PresentationModels.FieldType.ctor(Typeof(System.Nullable$1.ctor)), new Neptuo.PresentationModels.BindingConverters.NullBindingConverter$1.ctor(System.Int32.ctor, new Neptuo.PresentationModels.BindingConverters.IntBindingConverter.ctor())).Add(new Neptuo.PresentationModels.FieldType.ctor(Typeof(System.Nullable$1.ctor)), new Neptuo.PresentationModels.BindingConverters.NullBindingConverter$1.ctor(System.Double.ctor, new Neptuo.PresentationModels.BindingConverters.DoubleBindingConverter.ctor())).Add(new Neptuo.PresentationModels.FieldType.ctor(Typeof(System.Collections.Generic.IEnumerable$1.ctor)), new Neptuo.PresentationModels.BindingConverters.ListBindingConverter$1.ctor(System.Boolean.ctor, ",", new Neptuo.PresentationModels.BindingConverters.BoolBindingConverter.ctor())).Add(new Neptuo.PresentationModels.FieldType.ctor(Typeof(System.Collections.Generic.IEnumerable$1.ctor)), new Neptuo.PresentationModels.BindingConverters.ListBindingConverter$1.ctor(System.Int32.ctor, ",", new Neptuo.PresentationModels.BindingConverters.IntBindingConverter.ctor())).Add(new Neptuo.PresentationModels.FieldType.ctor(Typeof(System.Collections.Generic.IEnumerable$1.ctor)), new Neptuo.PresentationModels.BindingConverters.ListBindingConverter$1.ctor(System.Double.ctor, ",", new Neptuo.PresentationModels.BindingConverters.DoubleBindingConverter.ctor())).Add(new Neptuo.PresentationModels.FieldType.ctor(Typeof(System.Collections.Generic.IEnumerable$1.ctor)), new Neptuo.PresentationModels.BindingConverters.ListBindingConverter$1.ctor(System.String.ctor, ",", new Neptuo.PresentationModels.BindingConverters.StringBindingConverter.ctor(false, true, true)));
        }
    },
    assemblyName: "Neptuo.PresentationModels.BindingConverters",
    Kind: "Class",
...
var Neptuo$PresentationModels$BindingConverters$StringBindingConverter = {
    ...
    definition: {
        ctor: function (allowConvertNull, allowConvertEmpty, allowConvertWhitespace){
            ...
            Neptuo.PresentationModels.BindingConverters.BindingConverterBase$1.ctor.call(this, System.String.ctor);
